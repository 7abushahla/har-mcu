...
#SBATCH --job-name=m3-e12-t50-all
#
# One GPU job: E12 (Arduino from scratch @ T=50) for all seven model variants, back-to-back.
# Compare outputs to E10 @ T=100 (full_e10 or arch_seq/<variant>/e10).
# Artifacts: arch_seq/<model_variant>/e12/...
#
# From har-mcu repo root:
#   sbatch scripts/slurm/job_m3_seq_e12_t50_all_models.sh
#
...
CFG="configs/m3/E12_arduino_from_scratch_T50.yaml"
...
echo "Done E12 T=50 (all ${#MODEL_VARIANTS[@]} models)."
