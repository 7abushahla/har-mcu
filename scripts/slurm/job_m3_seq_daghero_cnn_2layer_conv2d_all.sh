...
#SBATCH --job-name=m3-seq-daghero
#
# One GPU: nine M3 experiments with model daghero_cnn_2layer_conv2d (sequential).
# Outputs under paths suffixed arch_seq/daghero_cnn_2layer_conv2d/{experiment_code}/...
# Each run uses --full-dataset (full windowed data; no smoke per-class cap).
#
#   sbatch scripts/slurm/job_m3_seq_daghero_cnn_2layer_conv2d_all.sh
#
