...
#SBATCH --job-name=m3-seq-tcnatt
#
# One GPU: nine M3 experiments with tcn_attention_har_teacher_conv2d (sequential).
#   sbatch scripts/slurm/job_m3_seq_tcn_attention_har_teacher_conv2d_all.sh
