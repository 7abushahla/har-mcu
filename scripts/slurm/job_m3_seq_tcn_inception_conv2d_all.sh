...
#SBATCH --job-name=m3-seq-tcninc
#
# One GPU: nine M3 experiments with tcn_inception_conv2d (sequential).
#   sbatch scripts/slurm/job_m3_seq_tcn_inception_conv2d_all.sh
