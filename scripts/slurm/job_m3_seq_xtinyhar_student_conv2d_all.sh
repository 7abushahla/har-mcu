...
#SBATCH --job-name=m3-seq-xthgelu
#
# One GPU: nine M3 experiments with xtinyhar_student_conv2d (GELU; sequential).
# E08 uses patch_size=10 (T50) per runbook.
#   sbatch scripts/slurm/job_m3_seq_xtinyhar_student_conv2d_all.sh
