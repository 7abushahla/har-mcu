...
- Inference latency p95: 4.286 ms/sample
- Timed samples: 256
- Warmup samples: 32
- Confusion matrix plot: `/shared/b00088568/github/har-mcu/reports/m3/no_accel_rotation/deepconv_lstm_conv2d/e07/m3/confusion_qat_deepconv_lstm_conv2d_E07_deepconv_lstm_r0_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.0000, R=0.0000, F1=0.0000, support=264
- Jogging: P=0.1923, R=0.0570, F1=0.0880, support=263
- Upstairs: P=0.1726, R=0.9811, F1=0.2935, support=264
