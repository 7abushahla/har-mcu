...
- Timed samples: 256
- Warmup samples: 32
- Confusion matrix plot: `/shared/b00088568/github/har-mcu/reports/m3/no_accel_rotation/daghero_cnn_2layer_conv2d/e11/m3/confusion_fp32_tflite_daghero_cnn_2layer_conv2d_E11_daghero_cnn_2layer_conv2d_r0_T50_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.9944, R=0.9981, F1=0.9962, support=529
- Jogging: P=1.0000, R=0.9905, F1=0.9952, support=528
- Upstairs: P=0.9712, R=0.9546, F1=0.9628, support=529
