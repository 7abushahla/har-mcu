...
- Inference latency median: 0.047 ms/sample
- Inference latency p95: 0.054 ms/sample
- Timed samples: 256
- Warmup samples: 32
- Confusion matrix plot: `/shared/b00088568/github/har-mcu/reports/m3/no_accel_rotation/daghero_cnn_2layer_conv2d/e12/m3/confusion_qat_daghero_cnn_2layer_conv2d_E12_daghero_cnn_2layer_conv2d_r0_T50_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.9851, R=0.9981, F1=0.9915, support=529
- Jogging: P=0.9924, R=0.9905, F1=0.9915, support=528
- Upstairs: P=0.9882, R=0.9471, F1=0.9672, support=529
- Downstairs: P=0.9614, R=0.9905, F1=0.9757, support=528
