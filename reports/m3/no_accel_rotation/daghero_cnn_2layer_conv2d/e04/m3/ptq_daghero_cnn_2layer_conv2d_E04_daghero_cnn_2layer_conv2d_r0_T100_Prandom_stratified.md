...
- Timed samples: 256
- Warmup samples: 32
- Confusion matrix plot: `/shared/b00088568/github/har-mcu/reports/m3/no_accel_rotation/daghero_cnn_2layer_conv2d/e04/m3/confusion_ptq_daghero_cnn_2layer_conv2d_E04_daghero_cnn_2layer_conv2d_r0_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.7000, R=0.0530, F1=0.0986, support=264
- Jogging: P=1.0000, R=0.4715, F1=0.6408, support=263
- Upstairs: P=0.2871, R=0.9811, F1=0.4443, support=264
