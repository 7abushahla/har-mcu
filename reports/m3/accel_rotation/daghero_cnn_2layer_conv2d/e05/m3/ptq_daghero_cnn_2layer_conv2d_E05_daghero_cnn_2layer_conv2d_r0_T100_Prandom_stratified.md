...
- Timed samples: 256
- Warmup samples: 32
- Confusion matrix plot: `/shared/b00088568/github/har-mcu/reports/m3/accel_rotation/daghero_cnn_2layer_conv2d/e05/m3/confusion_ptq_daghero_cnn_2layer_conv2d_E05_daghero_cnn_2layer_conv2d_r0_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.2768, R=0.3030, F1=0.2893, support=264
- Jogging: P=0.9918, R=0.9163, F1=0.9526, support=263
- Upstairs: P=0.3231, R=0.6402, F1=0.4295, support=264
