...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v2_bounded20_p025/on/daghero_cnn_2layer_conv2d/e04/confusion_on_qat_daghero_cnn_2layer_conv2d_e04_wisdm_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=1.0000, R=0.9949, F1=0.9974, support=2723
- Jogging: P=0.9958, R=1.0000, F1=0.9979, support=2109
- Upstairs: P=0.9835, R=0.9795, F1=0.9815, support=730
- Downstairs: P=0.9748, R=0.9898, F1=0.9822, support=587
