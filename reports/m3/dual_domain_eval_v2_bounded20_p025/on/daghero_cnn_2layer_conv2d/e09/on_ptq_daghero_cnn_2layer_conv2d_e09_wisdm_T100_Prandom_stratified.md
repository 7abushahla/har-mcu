...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v2_bounded20_p025/on/daghero_cnn_2layer_conv2d/e09/confusion_on_ptq_daghero_cnn_2layer_conv2d_e09_wisdm_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.0000, R=0.0000, F1=0.0000, support=2723
- Jogging: P=0.3247, R=1.0000, F1=0.4902, support=2109
- Upstairs: P=0.0087, R=0.0027, F1=0.0042, support=730
- Downstairs: P=0.0000, R=0.0000, F1=0.0000, support=587
- Sitting: P=1.0000, R=0.1417, F1=0.2483, support=381
