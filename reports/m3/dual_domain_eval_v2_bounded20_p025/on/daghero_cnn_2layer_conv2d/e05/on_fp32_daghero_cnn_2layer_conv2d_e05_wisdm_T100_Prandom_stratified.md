...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v2_bounded20_p025/on/daghero_cnn_2layer_conv2d/e05/confusion_on_fp32_daghero_cnn_2layer_conv2d_e05_wisdm_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.9982, R=0.9938, F1=0.9960, support=2723
- Jogging: P=0.9967, R=0.9986, F1=0.9976, support=2109
- Upstairs: P=0.9677, R=0.9836, F1=0.9755, support=730
