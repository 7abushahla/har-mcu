...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v2_bounded20_p025/on/daghero_cnn_2layer_conv2d/e08/confusion_on_qat_daghero_cnn_2layer_conv2d_e08_wisdm_T50_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.9918, R=0.9953, F1=0.9935, support=5482
- Jogging: P=0.9948, R=0.9962, F1=0.9955, support=4250
- Upstairs: P=0.9634, R=0.9572, F1=0.9603, support=1541
- Downstairs: P=0.9643, R=0.9520, F1=0.9581, support=1249
