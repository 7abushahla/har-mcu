# ON_PTQ_DEEPCONV_LSTM_CONV2D_E06_ARDUINO TFLite Evaluation (T=100, protocol=random_stratified)
...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v2_bounded20_p025/on/deepconv_lstm_conv2d/e06/confusion_on_ptq_deepconv_lstm_conv2d_e06_arduino_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.0000, R=0.0000, F1=0.0000, support=264
- Jogging: P=0.0000, R=0.0000, F1=0.0000, support=263
- Upstairs: P=0.1622, R=0.0682, F1=0.0960, support=264
- Downstairs: P=0.0000, R=0.0000, F1=0.0000, support=264
- Sitting: P=0.0000, R=0.0000, F1=0.0000, support=264
- Standing: P=0.1789, R=1.0000, F1=0.3035, support=263
