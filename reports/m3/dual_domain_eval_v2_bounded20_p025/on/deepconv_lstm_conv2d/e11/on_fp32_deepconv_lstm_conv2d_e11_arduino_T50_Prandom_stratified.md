...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v2_bounded20_p025/on/deepconv_lstm_conv2d/e11/confusion_on_fp32_deepconv_lstm_conv2d_e11_arduino_T50_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.9861, R=0.9376, F1=0.9612, support=529
- Jogging: P=1.0000, R=0.9223, F1=0.9596, support=528
- Upstairs: P=0.8076, R=0.9206, F1=0.8604, support=529
- Downstairs: P=0.9046, R=0.8977, F1=0.9011, support=528
- Sitting: P=0.9981, R=1.0000, F1=0.9991, support=528
- Standing: P=0.9962, R=0.9886, F1=0.9924, support=528
