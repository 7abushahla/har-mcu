...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v2_bounded20_p025_t50/off/daghero_cnn_2layer_conv2d/e11/confusion_off_qat_daghero_cnn_2layer_conv2d_e11_wisdm_T50_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.0769, R=0.0002, F1=0.0004, support=5482
- Jogging: P=0.3562, R=1.0000, F1=0.5253, support=4250
- Upstairs: P=0.1689, R=0.1694, F1=0.1692, support=1541
- Downstairs: P=0.0000, R=0.0000, F1=0.0000, support=1249
- Sitting: P=0.8733, R=0.4878, F1=0.6259, support=777
