...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v2_bounded20_p025_t50/on/daghero_cnn_2layer_conv2d/e11/confusion_on_qat_daghero_cnn_2layer_conv2d_e11_wisdm_T50_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.0000, R=0.0000, F1=0.0000, support=5482
- Jogging: P=0.3346, R=1.0000, F1=0.5014, support=4250
- Upstairs: P=0.0557, R=0.0286, F1=0.0378, support=1541
- Downstairs: P=0.1333, R=0.0032, F1=0.0063, support=1249
- Sitting: P=0.7157, R=0.3694, F1=0.4873, support=777
