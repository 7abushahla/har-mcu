...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v2_bounded20_p025_t50/on/daghero_cnn_2layer_conv2d/e12/confusion_on_fp32_daghero_cnn_2layer_conv2d_e12_wisdm_T50_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.0000, R=0.0000, F1=0.0000, support=5482
- Jogging: P=0.4291, R=0.9849, F1=0.5977, support=4250
- Upstairs: P=0.2191, R=0.5393, F1=0.3116, support=1541
- Downstairs: P=0.5000, R=0.0016, F1=0.0032, support=1249
- Sitting: P=0.8437, R=0.4028, F1=0.5453, support=777
