...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v3_target_clusters_p025/off/deepconv_lstm_conv2d/e09/confusion_off_fp32_deepconv_lstm_conv2d_e09_arduino_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.9924, R=0.9886, F1=0.9905, support=264
- Jogging: P=0.9962, R=0.9886, F1=0.9924, support=263
- Upstairs: P=0.9594, R=0.9848, F1=0.9720, support=264
