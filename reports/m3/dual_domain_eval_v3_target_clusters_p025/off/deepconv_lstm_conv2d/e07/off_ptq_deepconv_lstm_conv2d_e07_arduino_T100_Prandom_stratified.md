# OFF_PTQ_DEEPCONV_LSTM_CONV2D_E07_ARDUINO TFLite Evaluation (T=100, protocol=random_stratified)
...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v3_target_clusters_p025/off/deepconv_lstm_conv2d/e07/confusion_off_ptq_deepconv_lstm_conv2d_e07_arduino_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.0000, R=0.0000, F1=0.0000, support=264
- Jogging: P=0.0000, R=0.0000, F1=0.0000, support=263
- Upstairs: P=0.1596, R=0.2008, F1=0.1779, support=264
- Downstairs: P=0.0000, R=0.0000, F1=0.0000, support=264
- Sitting: P=0.0000, R=0.0000, F1=0.0000, support=264
- Standing: P=0.2104, R=1.0000, F1=0.3477, support=263
