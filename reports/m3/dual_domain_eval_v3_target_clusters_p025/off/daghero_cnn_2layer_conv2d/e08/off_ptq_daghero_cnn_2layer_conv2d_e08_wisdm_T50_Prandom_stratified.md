...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v3_target_clusters_p025/off/daghero_cnn_2layer_conv2d/e08/confusion_off_ptq_daghero_cnn_2layer_conv2d_e08_wisdm_T50_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.9949, R=0.9936, F1=0.9943, support=5482
- Jogging: P=0.9923, R=0.9974, F1=0.9948, support=4250
- Upstairs: P=0.9643, R=0.9455, F1=0.9548, support=1541
- Downstairs: P=0.9470, R=0.9576, F1=0.9522, support=1249
