# OFF_PTQ_DAGHERO_CNN_2LAYER_CONV2D_E09_ARDUINO TFLite Evaluation (T=100, protocol=random_stratified)
...
- Confusion matrix plot: `reports/m3/dual_domain_eval_v3_target_clusters_p025/off/daghero_cnn_2layer_conv2d/e09/confusion_off_ptq_daghero_cnn_2layer_conv2d_e09_arduino_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.9925, R=1.0000, F1=0.9962, support=264
- Jogging: P=1.0000, R=0.9886, F1=0.9943, support=263
- Upstairs: P=0.9848, R=0.9848, F1=0.9848, support=264
