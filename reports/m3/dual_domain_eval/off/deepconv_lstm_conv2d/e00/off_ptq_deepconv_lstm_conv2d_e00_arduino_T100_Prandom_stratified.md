# OFF_PTQ_DEEPCONV_LSTM_CONV2D_E00_ARDUINO TFLite Evaluation (T=100, protocol=random_stratified)
...
- Confusion matrix plot: `reports/m3/dual_domain_eval/off/deepconv_lstm_conv2d/e00/confusion_off_ptq_deepconv_lstm_conv2d_e00_arduino_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.0000, R=0.0000, F1=0.0000, support=264
- Jogging: P=0.0000, R=0.0000, F1=0.0000, support=263
- Upstairs: P=0.1937, R=0.9962, F1=0.3243, support=264
- Downstairs: P=0.0000, R=0.0000, F1=0.0000, support=264
- Sitting: P=0.0000, R=0.0000, F1=0.0000, support=264
- Standing: P=0.2377, R=0.2015, F1=0.2181, support=263
