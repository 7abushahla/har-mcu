...
- Confusion matrix plot: `reports/m3/dual_domain_eval/off/deepconv_lstm_conv2d/e10/confusion_off_fp32_deepconv_lstm_conv2d_e10_wisdm_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.0000, R=0.0000, F1=0.0000, support=2723
- Jogging: P=0.4048, R=0.9033, F1=0.5591, support=2109
- Upstairs: P=0.1686, R=0.2959, F1=0.2148, support=730
- Downstairs: P=0.1024, R=0.0954, F1=0.0988, support=587
- Sitting: P=0.6400, R=0.5039, F1=0.5639, support=381
