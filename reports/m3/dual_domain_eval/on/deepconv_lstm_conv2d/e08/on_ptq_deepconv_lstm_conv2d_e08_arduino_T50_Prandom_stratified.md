# ON_PTQ_DEEPCONV_LSTM_CONV2D_E08_ARDUINO TFLite Evaluation (T=50, protocol=random_stratified)
...
- Confusion matrix plot: `reports/m3/dual_domain_eval/on/deepconv_lstm_conv2d/e08/confusion_on_ptq_deepconv_lstm_conv2d_e08_arduino_T50_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.1616, R=0.2987, F1=0.2097, support=529
...
- Sitting: P=0.1674, R=0.6951, F1=0.2699, support=528
