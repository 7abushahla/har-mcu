...
- Confusion matrix plot: `reports/m3/dual_domain_eval/on/daghero_cnn_2layer_conv2d/e10/confusion_on_ptq_daghero_cnn_2layer_conv2d_e10_wisdm_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.0000, R=0.0000, F1=0.0000, support=2723
- Jogging: P=0.3446, R=1.0000, F1=0.5125, support=2109
- Upstairs: P=0.0393, R=0.0384, F1=0.0388, support=730
