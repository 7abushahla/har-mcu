...
- Timed samples: 256
- Warmup samples: 32
- Confusion matrix plot: `/shared/b00088568/github/har-mcu/reports/m3/accel_rotation_v3_target_clusters_p025/daghero_cnn_2layer_conv2d/e05/m3/confusion_ptq_daghero_cnn_2layer_conv2d_E05_daghero_cnn_2layer_conv2d_r0_T100_Prandom_stratified.png`

## Per-class metrics

- Walking: P=0.4412, R=0.0568, F1=0.1007, support=264
- Jogging: P=1.0000, R=0.5133, F1=0.6784, support=263
- Upstairs: P=0.2885, R=0.9659, F1=0.4443, support=264
