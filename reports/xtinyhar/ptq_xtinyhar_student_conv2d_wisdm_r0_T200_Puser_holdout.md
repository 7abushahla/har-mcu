...
- Inference latency median: 0.184 ms/sample
- Inference latency p95: 0.291 ms/sample
- Timed samples: 256
- Warmup samples: 32
...
- Walking: P=0.8164, R=0.8672, F1=0.8410, support=1333
- Jogging: P=0.9721, R=0.9583, F1=0.9651, support=1126
- Upstairs: P=0.4330, R=0.3762, F1=0.4026, support=412
- Downstairs: P=0.2857, R=0.0561, F1=0.0938, support=285
- Sitting: P=0.9730, R=0.8504, F1=0.9076, support=127
- Standing: P=0.3120, R=0.8819, F1=0.4609, support=127
